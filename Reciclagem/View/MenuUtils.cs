...
{
    public class MenuUtils<T> // T utilizado é usado para chamar o tipo generico
    {
        public static int ExibirMenuPadrao()
        {
            ...
            #region BODY 
            string bordaLinha = "||"; // essa parte do código trata o maior titulo do menu e insere as bordas laterais
